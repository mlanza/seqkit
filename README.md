...
There is a custom `skills` and an `about` tool which together facilitate knowledge lookup.  They're available to OpenCode when you start it in the repo.  Symlink them into your global opencode config for tools to make them universally available.
